...
7. 溶解蛋白于20μL 8M urea，100mM Tris pH8.5。超声15min-20min辅助蛋白溶解。（先配制0.5M Tris pH8.5，然后称取240mg urea、100μL 0.5M Tris pH8.5和220μL ddH2O配制成500μL 的8M urea）
8. 还原蛋白二硫键：加入1μL的100mM TCEP，终浓度为5mM,于室温反应20min。
9. 封闭二硫键：加入0.4μL的500mM IAA，终浓度为10mM,于室温反应15min。
10. 加入3倍体积的100mM Tris pH8.5，将urea稀释到2M。
11. 抑制糜蛋白酶活性：加入0.8μL 100mM CaCl2，终浓度为1mM.
12. 减少urea对肽段N端的氨甲酰化修饰：加入0.8μL 的2M 甲胺，终浓度为20mM。
13. 加入胰蛋白酶：酶和蛋白的质量比为1：20-1：100，37度避光酶切12-16小时。（胰蛋白酶购自promega, Catalog number selected: V5280）
14. 终止酶切反应：加入4μL 99%的甲酸终止酶切反应，终浓度为5%。
15. 使用脱盐Tip对样品进行除盐，最后抽干溶剂。（该步骤需要结合Tip的使用说明书进行）
